...
Usage:
    ...
    uv run scripts/visualize_palette.py results/6+6-sharedC.json --dark --no-show
"""
...
def parse_args(argv=None):
    ...
    parser.add_argument("--dark", action="store_true", help="render on a dark surface")
...
def main(argv=None):
    ...
    theme = plot.theme_for(args.dark)
